...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("seed1.peonycredit.org", "seed1.peonycredit.org"));

        base58Prefixes[PUBKEY_ADDRESS] = 55;
        base58Prefixes[SCRIPT_ADDRESS] = 9;
        base58Prefixes[SECRET_KEY] = 183;
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testseed.peonycredit.org", "testseed1.peonycredit.org"));
